...
public class EntityBullet_back extends Entity implements IEntityAdditionalSpawnData {
	...
	public EntityBullet_back(World worldIn) {
		super(worldIn);
	...
	/* データマネージャーパラメータ */
	private static final DataParameter<Vec3d> Vec3d = EntityDataManager.createKey(EntityBullet_back.class,
			PacketHandler.Vec3d);
	private static final DataParameter<Byte> Flag = EntityDataManager.createKey(EntityBullet_back.class,
	...
	public EntityBullet_back(GunData gun, MagazineData magazine, Entity shooter, boolean isADS, float offset, double x,
