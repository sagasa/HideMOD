...
public class GunData extends ItemData {
	...
	/** デフォルトリコイル : Recoil */
	public static final DataEntry<hide.types.effects.Recoil> Recoil = of(new Recoil());
	/** ADSリコイル : デフォルトに加算 : Recoil */
	public static final DataEntry<hide.types.effects.Recoil> RecoilADS = of(new Recoil());
	/** スニークリコイル : デフォルトに加算 : GunRecoil型 */
	public static final DataEntry<hide.types.effects.Recoil> RecoilSneak = of(new Recoil());
	/** スニークADSリコイル : デフォルトに加算 : GunRecoil型 */
	public static final DataEntry<hide.types.effects.Recoil> RecoilSneakADS = of(new Recoil());
	...
	/** 爆発 : Explosion型 **/
	public static final DataEntry<hide.types.effects.Explosion> Explosion = of(new Explosion(),
			new Info().Cate(ExplosionInfo));
	/** 地面に当たった時の爆発 基礎値に加算 : Explosion型 **/
	public static final DataEntry<hide.types.effects.Explosion> ExplosionHitGround = of(new Explosion(),
			new Info().Cate(ExplosionInfo));
	/** エンティティに当たった時の爆発 基礎値に加算 : Explosion型 **/
	public static final DataEntry<hide.types.effects.Explosion> ExplosionHitEntity = of(new Explosion(),
			new Info().Cate(ExplosionInfo));
	/** 時間経過の爆発 基礎値に加算 : Explosion型 **/
	public static final DataEntry<hide.types.effects.Explosion> ExplosionTimeout = of(new Explosion(),
			new Info().Cate(ExplosionInfo));
